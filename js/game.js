...
function iHeartYou(){
	...
	document.getElementById("screen_two").style.background = "#FF9999";
...
window.LEVEL_CONFIG = [
	...
	// p
	{
		...
		circles: [
			...
			{x:150,y:150,radius:10,invisible:true},
			{x:150,y:300,radius:50},
			{x:150,y:250,radius:10,invisible:true}
		],
...
// y
{
	...
	key:{ x:250, y:60 },
	circles: [
		{x:150,y:40,radius:60},
		{x:150,y:190,radius:40}
	],
	countdown:120
}	
